...
public class TUserDAO extends HibernateDaoSupport
{
	...
	public List findAll(String name,String tel)
	{
		log.debug("finding all TUser instances");
		try
		{
			String sql = "from TUser where userDel='no' and zt = 'Í¨¹ý' ";
			if(name!=null && !name.equals("")){
				sql = sql + " and userRealname like '%"+name+"%'";
			}
			if(tel!=null && !tel.equals("")){
				sql = sql + " and userTel like '%"+tel+"%'";
			}
