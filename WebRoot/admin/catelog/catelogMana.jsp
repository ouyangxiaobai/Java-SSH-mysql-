...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
        ...
        <script language="javascript">
           ...
           function catelogAdd()
           {
                 var url="<%=path %>/toAddCatelog.action";
                 //var n="";
                 //var w="480px";
                 //var h="500px";
	...
	<body leftmargin="2" topmargin="2" background='<%=path %>/images/allbg.gif'>
			<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
				<tr bgcolor="#E7E7E7">
					<td height="14" colspan="5" background="<%=path %>/images/tbg.gif">&nbsp;信息类别&nbsp;</td>
				</tr>
				...
				<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
					...
					<td bgcolor="#FFFFFF" align="center">
						...
						<s:if test="#catelog.pid==0">一级分类</s:if>
						<s:if test="#catelog.pid!=0">二级分类</s:if>
					</td>
					
					
					<td bgcolor="#FFFFFF" align="center">
					    <a href="catelogEdit.action?catelogId=<s:property value="#catelog.catelogId"/>"   class="pn-loperator">修改</a>
					    &nbsp;
