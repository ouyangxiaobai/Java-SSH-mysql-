...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body leftmargin="2" topmargin="9" background='<%=path %>/images/allbg.gif'>
			<form action="<%=path %>/newsEditSave.action" name="formAdd" method="post">
				     <table width="98%" align="center" border="0" cellpadding="4" cellspacing="1" bgcolor="#CBD8AC" style="margin-bottom:8px">
						<tr bgcolor="#EEF4EA">
					        <td colspan="3" background="<%=path %>/images/wbg.gif" class='title'><span>信息编辑</span></td>
					    </tr>
						...
						<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
						    ...
						    <td width="75%" bgcolor="#FFFFFF" align="left">
						    <input type="hidden" name="newsId" size="20" value="<s:property value="#request.news.newsId"/>"/>
						        <input type="text" id="newsTitle" name="newsTitle" style="width: 210px;" value="<s:property value="#request.news.newsTitle"/>"/>
						...
						<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
						    ...
						    <td width="75%" bgcolor="#FFFFFF" align="left">
						       <FCK:editor instanceName="newsContent"  basePath="/fckeditor" width="500" height="200" value="${news.newsContent}" toolbarSet="Basic">
                                </FCK:editor> 
						    </td>
						</tr>
